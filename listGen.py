...
for e in pp:
    print('<div class=\"movieItem\" onclick=\"MovieOverlayOn(\'',e,'\')\"><div class=\"movie_img_wrap\"><img src=\"videos/movies/',e,'/thumb.jpg\" width=\"100%\"><p class=\"movie_image_description\">',e,'</p></div></div>',sep='',end='',file=moviesOutputTxt)
os.chdir('..')
